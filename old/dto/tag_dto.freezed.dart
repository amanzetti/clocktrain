...
abstract class $TagDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, UserDto? user, bool isGlobal});
...
class _$TagDtoImpl implements _TagDto {
  ...
  @override
  String toString() {
    return 'TagDto(id: $id, name: $name, user: $user, isGlobal: $isGlobal)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, user, isGlobal);
...
abstract class _TagDto implements TagDto {
  const factory _TagDto(
      ...
      final UserDto? user,
      required final bool isGlobal}) = _$TagDtoImpl;
